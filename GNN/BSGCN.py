...
class PPGCN(object):
    ...
    def forward_propagation(self):
        ...
        with tf.variable_scope('spectral_gcn'):
            gcn_out = GCN(tf.expand_dims(self.x, 0), weighted_adj, [self.gcn_output1, #self.gcn_output2,
...
if __name__ == "__main__":
    ...
    with open("ppgcn_result/parameter.txt","w") as f:
    ...
    with tf.Session() as sess:
        net = PPGCN(class_size=class_size,gcn_output1=gcn_para[0], #gcn_output2=gcn_para[1],
...
#                    print(prob)
                if index % 320 == 0:
                    ...
                    '''
                    with open("ppgcn_result/test_acc.txt","a+") as f:
                         f.write(str(eva_acc))
                         f.write("\n")
                    '''
                ...
                if acc > max_acc:
                    max_acc = acc
                    f = open('ppgcn_result/results_new.txt', 'w')
